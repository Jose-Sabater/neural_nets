...
nn = Network()
nn.add_layer(FCLayer(28 * 28, 100))  # input (1, 28*28) outpu (100)
nn.add_layer(ActivationLayer(tanh, tanh_prime))
nn.add_layer(FCLayer(100, 50))
nn.add_layer(ActivationLayer(tanh, tanh_prime))
nn.add_layer(FCLayer(50, 10))
nn.add_layer(ActivationLayer(tanh, tanh_prime))

nn.set_loss(mse, mse_prime)
nn.fit(x_train[0:10000], y_train[0:10000], epochs=50, learning_rate=0.1)
